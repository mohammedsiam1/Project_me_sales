                                ...
                                <div class="col-md-12 mb-3" wire:ignore>
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <button class="nav-link fw-bold"  wire:loading.attr="disabled" id="cashOnDeliveryTab-tab" data-bs-toggle="pill" data-bs-target="#cashOnDeliveryTab" type="button" role="tab" aria-controls="cashOnDeliveryTab" aria-selected="true">Cash on Delivery</button>
...
<!--                                                 <button type="button" wire:loading.attr="disabled" class="btn btn-warning">Pay Now (Online Payment)</button>
 -->                                                <div wire:ignore>
            ...
            @else 
            <div class="cart cart-body shadow text-center p-md-5">
                <h4>No items in your cart !</h4>
                <a href="{{url('user/category')}}" class="btn btn-warning">Shop now</a>
            </div>
            @endif
        </div>
    </div>
...
@push('scripts')
<script src="https://www.paypal.com/sdk/js?client-id=AX-M0RVbbOwXJjaZGgA6K3YxR1aDMjfc8au9V8Rr4b75ZyGUHu7BLFobp7GXYQ0ddD3nQlwPqUGgQ5qq&currency=USD"></script>
<script>
      paypal.Buttons({
        ...
        onApprove: (data, actions) => {
          return actions.order.capture().then(function(orderData) {
            ...
            if(transaction.status == "COMPLETED"){
                Livewire.emit('CompletePayment',transaction.id)
            }else{
